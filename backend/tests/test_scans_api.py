...
def test_scanner_catalog_marks_unimplemented_modules_unavailable(client, planned_api):
    client.register()
...
def test_unavailable_or_unknown_scanner_rejected(client, fake_scanner, planned_api):
